...
1) (Step_1) Generate Cartesian coordinates of any random conformer of a system (e.g. m1_00_PEt2Ph.xyz in Step_1)
2) Optimize your random conformer, e.g. with ORCA:
...
d) run Uniconf on generated file ```m1_00_PEt2Ph-PBE0-D3-TZ-uni.inp```:
